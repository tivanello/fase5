...
""")
        ...
        st.markdown("""
        **Colunas obrigatórias do modelo:**  
        * ano_base  
        * IDA  
        * IEG  
        * IAA  
        ...
        * target_defasagem_atual  
        ...
        Você também deve incluir **coluna(s) extra(s)**, como *RA*, ID do aluno, Matricula. Essas informações são necessárias para que identifique o aluno, para identificação dos alunos.
        """)
